    ...
    <Card className="p-6">
      <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-800">
        <h3 className="text-xs font-mono uppercase font-bold text-slate-200 tracking-wider flex items-center gap-2">
          <ShieldCheck className="h-4 w-4 text-emerald-400" /> THREAT TELEMETRY OVERVIEW
        </h3>
        <span className="text-[10px] font-mono text-emerald-400 font-semibold px-2 py-0.5 rounded bg-emerald-950/80 border border-emerald-800">
          <Lock className="h-3 w-3 inline mr-1" /> HARDWARE ONE-WAY ISOLATED
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 font-mono text-xs">
        ...
        <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
          <span className="text-[10px] text-slate-500 block">PROTOCOL / FLOW</span>
          <span className="text-emerald-400 font-bold text-sm">{threat.protocol}</span>
        </div>
        ...
        <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
          <span className="text-[10px] text-slate-500 block">CONNECTION ATTEMPTS</span>
          <span className="text-orange-400 font-bold text-sm">{threat.connectionAttempts.toLocaleString()}</span>
        </div>

        <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
          <span className="text-[10px] text-slate-500 block">PORTS TARGETED</span>
          <span className="text-orange-400 font-bold text-sm">{threat.destinationPortCount} Ports</span>
        </div>

        <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
          <span className="text-[10px] text-slate-500 block">ESTIMATED BYTES</span>
        ...
        <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
          <span className="text-[10px] text-slate-500 block">TRAFFIC DIRECTION</span>
      ...
      <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-center">
        <span className="text-[10px] font-mono text-slate-500 uppercase block mb-3">
          UNIDIRECTIONAL SECURITY BOUNDARY FLOW
        </span>

        <div className="grid grid-cols-11 gap-1 items-center py-2">
          {/* Source Host */}
          <div className="col-span-3 p-3 rounded-lg bg-slate-900 border border-slate-800">
            <Server className="h-4 w-4 text-slate-400 mx-auto mb-1" />
            <span className="text-[9px] font-mono text-slate-500 block">SOURCE NETWORK</span>
          ...
          <div className="col-span-1 flex items-center justify-center">
            <div className="w-full h-0.5 bg-gradient-to-r from-emerald-500 to-teal-400 relative">
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-0 h-0 border-y-3 border-y-transparent border-l-4 border-l-teal-400" />
            </div>
          </div>

          {/* AI Analysis Node */}
          <div className="col-span-3 p-3 rounded-lg bg-emerald-950/40 border border-emerald-800/80 shadow-soc-glow">
            <Cpu className="h-4 w-4 text-emerald-400 mx-auto mb-1 animate-pulse" />
            <span className="text-[9px] font-mono text-emerald-300 font-bold block">AI ANALYSIS</span>
            <span className="text-[10px] font-mono text-slate-400">Diode Inspection</span>
          </div>

          {/* Arrow 2 */}
          <div className="col-span-1 flex items-center justify-center">
            <div className="w-full h-0.5 bg-gradient-to-r from-teal-400 to-cyan-400 relative">
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-0 h-0 border-y-3 border-y-transparent border-l-4 border-l-cyan-400" />
            </div>
          </div>
          ...
          <div className="col-span-3 p-3 rounded-lg bg-slate-900 border border-slate-800">
            ...
            <span className="text-[9px] font-mono text-slate-500 block">PROTECTED NETWORK</span>
